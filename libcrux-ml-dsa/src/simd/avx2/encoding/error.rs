...
#[hax_lib::requires(
    fstar!(r"forall (i: nat {i < 256}). i % 32 >= 3 ==> ${simd_unit_shifted}.(mk_int i) == Libcrux_test_foo_bar_core_models.Abstractions.Bit.Bit_Zero")
)]
...
#[hax_lib::requires(
    fstar!(r"forall (i: nat {i < 256}). i % 32 >= 4 ==> ${simd_unit_shifted}.(mk_int i) == Libcrux_test_foo_bar_core_models.Abstractions.Bit.Bit_Zero")
)]
#[hax_lib::ensures(|result| {
...
/\ (forall (i: nat {i < 256}). i % 32 >= 3 ==> Libcrux_test_foo_bar_core_models.Abstractions.Bit.Bit_Zero? ${result}.(mk_int i))
"#))]
...
/\ (forall (i: nat {i < 256}). i % 32 >= 4 ==> Libcrux_test_foo_bar_core_models.Abstractions.Bit.Bit_Zero? ${result}.(mk_int i))
"#))]
