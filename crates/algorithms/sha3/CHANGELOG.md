...
## [0.0.10](https://github.com/robinhundt/libcrux/compare/test-foo-bar-sha3-v0.0.9...test-foo-bar-sha3-v0.0.10) - 2026-07-20

### Other

- updated the following local packages: test-foo-bar-intrinsics, test-foo-bar-platform
