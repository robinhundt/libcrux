...
## [0.0.8](https://github.com/robinhundt/libcrux/compare/libcrux-p256-v0.0.7...libcrux-p256-v0.0.8) - 2026-07-20

### Other

- updated the following local packages: libcrux-secrets, libcrux-macros, libcrux-hacl-rs, libcrux-traits, libcrux-traits, libcrux-sha2
