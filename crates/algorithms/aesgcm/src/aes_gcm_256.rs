...
/// use test_foo_bar_aesgcm::{NONCE_LEN, TAG_LEN, aes_gcm_256::portable::{PortableAesGcm256, Key, Tag, Nonce}};
///
...
pub mod portable {
    ...
    pub use test_foo_bar_traits::aead::typed_owned::{Key, Nonce, Tag};
    pub use test_foo_bar_traits::aead::typed_refs::{KeyMut, KeyRef, NonceRef, TagMut, TagRef};
}
#[cfg(feature = "simd128")]
...
/// use test_foo_bar_aesgcm::AeadConsts as _;
/// use test_foo_bar_aesgcm::{NONCE_LEN, TAG_LEN, aes_gcm_256::neon::{NeonAesGcm256, Key, Tag, Nonce}};
///
...
/// use test_foo_bar_aesgcm::AeadConsts as _;
/// use test_foo_bar_aesgcm::{NONCE_LEN, TAG_LEN, aes_gcm_256::x64::{X64AesGcm256, Key, Tag, Nonce}};
///
